// Adapted from http://mech.math.msu.su/~vvb/2course/Borisenko/CppProjects/GWindow/xintro.html
...
Bool pred(Display *dis, XEvent *ev, XPointer arg) {
printf("%p - %p - %p\n", dis, ev, arg);
return True;
}
